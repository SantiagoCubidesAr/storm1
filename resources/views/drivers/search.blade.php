    ...
    <div class="table-responsive text-nowrap vh-100">
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$driver->fullname}}</strong></td>
                    <td>
                    ...
                    <td><span class="badge bg-label-primary me-1">{{$driver->status->status}}</span></td>
                    <td>
                        <div class="dropdown">
